...
var concert = function () {
  ...
  // var URL = "https://rest.bandsintown.com/artists/Halestorm/events?app_id=codingbootcamp"
  // use axios.get with query variable
  if (!artist) {
    console.log("\n----Try again, please. Remember to choose an artist or band.----\n")
  }
  axios.get(URL).then(function (response) {
    ...
    var time = moment(data.datetime).format("LLLL");
